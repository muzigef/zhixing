...
| 切片 | 目标 | 状态 |
| --- | --- | --- |
| P4-01 | 创建主题、持久化注册表、受控目录初始化 | 进行中 |
| P4-02 | 画像驱动的定制课程草案与显式启用 | 待开始 |
| P4-03 | 主题概览、唯一下一步与本地提醒计划 | 待开始 |

## 后续工作原则

P0–P3 已完成；P4 按上表自动推进。任何新需求应创建新的任务切片，并先定义安全边界、测试和 Evidence；不得把可选真实 Provider smoke 当作本地发布阻塞项。
