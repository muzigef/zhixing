...
截至 2026-09-07，最新记录为在 `13b88f0` 基础上完成的 0.4.1 Pi 延迟修复与实包验证。Evidence 是各次实际执行的快照：保留原始测试数量、失败和未验证项，不将历史结果追改成今天的结果。现行功能见 [功能与验收](../features-and-acceptance.md)，配置见 [配置](../CONFIGURATION.md)。
