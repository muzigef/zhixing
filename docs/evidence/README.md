...
截至 2026-09-07，最新源码记录为基于 `8bc5124` 的教学效果验证，最新安装包记录仍为 0.4.1 Pi 延迟修复。Evidence 是各次实际执行的快照：保留原始测试数量、失败和未验证项，不将历史结果追改成今天的结果。现行功能见 [功能与验收](../features-and-acceptance.md)，配置见 [配置](../CONFIGURATION.md)。
