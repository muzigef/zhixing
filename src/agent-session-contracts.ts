import { teamConfigurationSchema, teamSnapshotSchema } from "./team-contracts.js";
import { providerSchema } from "./agent-provider.js";
export { providerSchema } from "./agent-provider.js";
...
export const agentSendSchema = z.object({
  ...
  resumeTaskId: z.string().uuid().optional(), retryTeamTaskId: z.string().uuid().optional(),
  steerId: z.string().uuid().optional(),
}).strict();
