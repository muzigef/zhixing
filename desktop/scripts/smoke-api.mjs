...
try {
  ...
  console.log("API UI passed: independent Kimi/DeepSeek credentials, masked input, draft reset, connection test, provider badge, restart existing DeepSeek compatibility, custom vendor add/rename/key retention/select/probe/chat/restart/remove, stale revision and missing-provider rejection. HTTP and cipher use isolated fixtures.");
} finally {
